...
class HouseholdModelClass(EconModelClass):
    ...
    def setup(self):
        ...
        par.wage_K_1 = 0.001 # return on human capital, men
        par.wage_K_2 = 0.001 # return on human capital, women
    ...
    def simulate_single_life(self):
        ...
        for i in range(par.simN):
            ...
            for t in range(par.simT):
                ...
                if t < par.simT - 1:
                    income_w = wage_func(self,sim.kw[i, t], woman) * sim.Hw[i, t]
                    income_m = wage_func(self,sim.km[i, t], man) * sim.Hm[i, t]
        ...
        # Print some results
        print(f"sim.Cw_tot: {sim.Cw_tot}")
        print(f"sim.Cm_tot: {sim.Cm_tot}")
        print(f"sim.Hw: {sim.Hw}")
        print(f"sim.Hm: {sim.Hm}")
        print(f"sim.Aw: {sim.Aw}")
        print(f"sim.Am: {sim.Am}")
        print(f"sim.kw: {sim.kw}")
        print(f"sim.km: {sim.km}")
